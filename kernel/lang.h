...
typedef enum {
    ...
    STR_CONFIG_CATEGORY_SYSTEM,
    STR_CONFIG_CATEGORY_PERSONALIZATION,
    STR_CONFIG_CATEGORY_ABOUT,
    STR_CONFIG_SECTION_LANGUAGE_DESC,
    ...
    STR_EDITOR_TITLE,
    STR_EDITOR_SAVED,
    STR_EDITOR_SAVE_FAILED,
    STR_EDITOR_COPIED,
    STR_EDITOR_CUT,
    STR_EDITOR_PASTED,
    STR_EDITOR_SAVEAS_PROMPT,
    STR_EDITOR_SAVEAS_HINT,
    STR_EDITOR_UNTITLED,
    STR_EDITOR_LINE_LABEL,
    STR_EDITOR_COL_LABEL,
    STR_EDITOR_CHARS_LABEL,
    STR_ICON_EDITOR,
    STR_TERM_HELP_EDIT,
