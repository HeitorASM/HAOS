...
typedef enum {
    ...
    // ---- Login screen ----
    STR_LOGIN_TITLE,
    STR_LOGIN_WELCOME_BACK,
    STR_LOGIN_FIRST_BOOT_TITLE,
    STR_LOGIN_NAME_PROMPT,
    STR_LOGIN_NAME_PLACEHOLDER,
    STR_LOGIN_ENTER_BTN,
    STR_LOGIN_DEFAULT_USER,
    STR_LOGIN_NEXT_BTN,
    STR_LOGIN_PASSWORD_TITLE,
    STR_LOGIN_PASSWORD_PROMPT,
    STR_LOGIN_PASSWORD_PLACEHOLDER,
    STR_LOGIN_SKIP_PASSWORD_BTN,
    STR_LOGIN_PASSWORD_PROMPT_ENTER,
    STR_LOGIN_PASSWORD_PLACEHOLDER_ENTER,

    // ---- Config: conta do usuário atual ----
    STR_CONFIG_ACCOUNT_SECTION,
    ...
    STR_FILE_MANAGER_TITLE,
    STR_FILE_MANAGER_BACK,
    STR_FILE_MANAGER_HOME,
    STR_FILE_MANAGER_NAME,
    STR_FILE_MANAGER_TYPE,
    STR_FILE_MANAGER_SIZE,
    STR_FILE_MANAGER_EMPTY,
    STR_FILE_MANAGER_BINARY,
    STR_FILE_MANAGER_OPENED,
